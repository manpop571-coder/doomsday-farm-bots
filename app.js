(function () {
  ...
  var T = {
    ar:{eyebrow:'لوحة التحكم',title:'Doomsday Farm Bots',choose:'اختر لغتك',chooseHint:'يمكنك تغيير اللغة لاحقًا من زر 🌐',telegramId:'معرّف تيليجرام',farm:'القلعة',start:'بداية الاشتراك',end:'نهاية الاشتراك',oil:'النفط',steel:'الصلب',wood:'الخشب',food:'الطعام',save:'💾 حفظ التعديلات',saving:'جارٍ الإرسال...',saved:'تم إرسال التعديلات إلى البوت',max:'لا يمكن أن يتجاوز إجمالي الفيالق 5',none:'لا توجد أي قلاع مرتبطة بحسابك.',on:'تشغيل',off:'إيقاف',total:'إجمالي الفيالق',changeLanguage:'تغيير اللغة',openTelegram:'افتح هذه الصفحة من داخل بوت تيليجرام للحفظ',invalidData:'تعذر قراءة بيانات القلاع. افتح الواجهة من البوت مرة أخرى.'},
    en:{eyebrow:'CONTROL PANEL',title:'Doomsday Farm Bots',choose:'Choose your language',chooseHint:'You can change it later using the 🌐 button.',telegramId:'Telegram ID',farm:'Farm',start:'Subscription starts',end:'Subscription ends',oil:'Oil',steel:'Steel',wood:'Wood',food:'Food',save:'💾 Save changes',saving:'Sending...',saved:'Changes were sent to the bot',max:'The total number of legions cannot exceed 5',none:'No farms are linked to your account.',on:'ON',off:'OFF',total:'Total legions',changeLanguage:'Change language',openTelegram:'Open this page from the Telegram bot to save changes',invalidData:'Farm data could not be read. Open the panel from the bot again.'},
    fr:{eyebrow:'PANNEAU DE CONTRÔLE',title:'Doomsday Farm Bots',choose:'Choisissez votre langue',chooseHint:'Vous pourrez la modifier plus tard avec le bouton 🌐.',telegramId:'Identifiant Telegram',farm:'Ferme',start:'Début de l’abonnement',end:'Fin de l’abonnement',oil:'Pétrole',steel:'Acier',wood:'Bois',food:'Nourriture',save:'💾 Enregistrer les modifications',saving:'Envoi...',saved:'Les modifications ont été envoyées au bot',max:'Le total des légions ne peut pas dépasser 5',none:'Aucune ferme n’est associée à votre compte.',on:'ACTIVÉ',off:'DÉSACTIVÉ',total:'Total des légions',changeLanguage:'Changer de langue',openTelegram:'Ouvrez cette page depuis le bot Telegram pour enregistrer',invalidData:'Impossible de lire les données. Rouvrez le panneau depuis le bot.'},
    ...
    zh:{eyebrow:'控制面板',title:'Doomsday Farm Bots',choose:'选择语言',chooseHint:'以后可通过 🌐 按钮更改语言。',telegramId:'Telegram ID',farm:'农场',start:'订阅开始日期',end:'订阅结束日期',oil:'石油',steel:'钢铁',wood:'木材',food:'食物',save:'💾 保存更改',saving:'正在发送...',saved:'更改已发送给机器人',max:'军团总数不能超过 5',none:'您的账户尚未关联任何农场。',on:'开启',off:'关闭',total:'军团总数',changeLanguage:'更改语言',openTelegram:'请从 Telegram 机器人中打开此页面以保存',invalidData:'无法读取农场数据。请从机器人重新打开控制面板。'},
    ...
    pt:{eyebrow:'PAINEL DE CONTROLE',title:'Doomsday Farm Bots',choose:'Escolha seu idioma',chooseHint:'Você poderá alterá-lo depois usando o botão 🌐.',telegramId:'ID do Telegram',farm:'Fazenda',start:'Início da assinatura',end:'Fim da assinatura',oil:'Petróleo',steel:'Aço',wood:'Madeira',food:'Comida',save:'💾 Salvar alterações',saving:'Enviando...',saved:'As alterações foram enviadas ao bot',max:'O total de legiões não pode ultrapassar 5',none:'Nenhuma fazenda está vinculada à sua conta.',on:'LIGADO',off:'DESLIGADO',total:'Total de legiões',changeLanguage:'Alterar idioma',openTelegram:'Abra esta página pelo bot do Telegram para salvar',invalidData:'Não foi possível ler os dados. Abra o painel novamente pelo bot.'},
      ...
      return '<article class="farm-card" data-index="' + index + '">' +
        '<div class="farm-head">' +
          '<div class="farm-title">' +
            '<h2>🏰 ' + tr('farm') + ' ' + escapeHtml(farm.id) + '</h2>' +
            '<div class="farm-file">' + escapeHtml(farm.file) + '</div>' +
          '</div>' +
